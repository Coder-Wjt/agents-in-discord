...
if (!['shared', 'codex', 'claude', 'antigravity', 'agy', 'zcode', 'pi', 'omp'].includes(mode)) {
  console.error('Usage: node scripts/start-instance.mjs <shared|codex|claude|antigravity|zcode|pi|omp>');
  process.exit(1);
}
